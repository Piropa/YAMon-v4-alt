...
function loadHourly(cleardata){
	...
	.done(function(dlist,textStatus){
		...
		if(isToday){
			...
			var o2u=!!interfaces['br0']?interfaces['br0']:interfaces['br-lan']?interfaces['br-lan']:interfaces['eth0']
...
function GrandTotalDaily(arr){
	...
	var o2u=!!monthly_totals.interfaces['br0']?monthly_totals.interfaces['br0']:monthly_totals.interfaces['br-lan']?monthly_totals.interfaces['br-lan']:monthly_totals.interfaces['eth0']
	//var pnd_data={'start':{'down':0,'up':0},'total':{'down':0,'up':0,'dropped':0,'local':0,'lost':0},'usage':[]}
	if (!o2u) return
	pnd_data.total.down+=o2u.down
	pnd_data.total.up+=o2u.up
